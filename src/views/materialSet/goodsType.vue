        ...
        <div class="pad_5 backfff">
            ...
            <div>
                <el-table :data="tableData" style="width:100%">
                    <el-table-column prop="pcategory" label="编号" width="100"></el-table-column>
        ...
        <el-dialog :title="modalTitle" :visible.sync="dialogVisible" width="40%">
            <div>
                <el-form ref="ruleForm" :model="ruleForm" :rules="rules" label-width="100px" class="demo-ruleForm">
                    <el-form-item label="编号" prop="pcategory">
                        <el-input v-model="ruleForm.pcategory" placeholder="请输入" :disabled="modalTitle=='编辑'"></el-input>
                    </el-form-item>
    ...
    export default {
        data() {
            return {
                ...
                rules: {
                    pcategory: [{required: true, message: '请输入编号', trigger: 'blur'}],
