            ...
            <div class="nav_header">
                <el-form :model="ruleForm" :rules="rules" ref="ruleForm" :inline="true" class="demo-form-inline">
                    ...
                    <el-form-item label="退货仓库"  prop="warehouseID">
                        <el-select v-model="ruleForm.warehouseID" filterable placeholder="请选择" @change="warehouseChange" size="mini">
                            <el-option
                    ...
                    <el-form-item label="经手单位"  prop="entityID">
                        <el-select v-model="ruleForm.entityID" placeholder="请选择" filterable clearable size="mini">
                            <el-option
                    ...
                    <el-table-column prop="inAmount" label="输入数量">
                        <template slot-scope="scope">
                            <el-input v-model="scope.row.inAmount"
                                      placeholder="请输入" @change="numberChange(scope.$index,scope.row)" v-enter-number></el-input>
                        </template>
                    </el-table-column>
                            ...
                            .then(res => {
                                if (res.stateCode == 100) {
                                    ...
                                    if(num==1){
                                        ...
                                        that.$router.push({path:"/procurementBusiness/purchaseReturn/purchaseReturn"})
                                    }
                                }else {
                                    that.$message.error({
                                        message: res.message,
