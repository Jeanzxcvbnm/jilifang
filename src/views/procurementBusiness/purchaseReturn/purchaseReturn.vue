        ...
        <div class="pad_5 backfff">
            ...
            <div>
                <el-table :data="tableData" style="width: 100%" highlight-current-row @current-change="detailClick">
                    ...
                    <el-table-column prop="warehouseName" label="退货仓库"></el-table-column>
                    ...
                    <el-table-column label="操作" width="180">
                        <template slot-scope="scope">
                            <el-button type="primary" size="mini" @click="showEditDialog(scope.row)" v-if="scope.row.isConfirm==0" >编辑 </el-button>
                            <el-button type="primary" size="mini" @click="showDetail(scope.row)"  v-if="scope.row.isConfirm==1">详情 </el-button>
                            <el-button type="primary" size="mini" @click.stop="sendClick(scope.row)" v-if="scope.row.isConfirm==0">发送订单 </el-button>
                        </template>
                    </el-table-column>
                </el-table>
        ...
        <div class="pad_10 backfff martp_15">
            ...
            <div>
                <el-table :data="orderDetail" show-summary :summary-method="getSummaries" max-height="400"
                    ...
                    <!--<el-table-column prop="amount" label="参考进价"></el-table-column>-->
    ...
    export default {
        ...
        methods: {
            ...
            handleDownload(){
                ...
                API.exportCT(params)
                    .then(res => {
                        ...
                        link.download = '采购退货.xlsx'; //下载的文件名
            ...
            showAddDialog: function () {
                var that = this;
                that.$router.push("/procurementBusiness/purchaseReturn/addPurchaseReturn")
            },
            // 数据显示
            ...
            search: function () {
                ...
                API.purchasingReturnList(params)
                    .then(res => {
                        if (res.stateCode == 100) {
            ...
            showEditDialog: function (row) {
                var that = this;
                that.$router.push({path: "/procurementBusiness/purchaseReturn/editPurchaseReturn", query: {detail: row}})
            },
            //详情
            showDetail: function (row) {
                var that = this;
                that.$router.push({path: "/procurementBusiness/purchaseReturn/purchaseReturnDetail", query: {detail: row}})
            },
            // 发送订单
