            ...
            <div class="border_bottom pad_20">
                <el-row>
                    ...
                    <el-col :span="20" class="text_right">
                        ...
                        <el-button type="primary" size="mini" @click="savaClick">保存变更</el-button>
                    </el-col>
                </el-row>
            </div>
...
<script>
    ...
    export default {
        ...
        mounted() {
            var that = this;
            var data= new Date();
            that.ruleForm.accountDate=that.getFirstDayOfMonth(data,1);
            that.ruleForm.maxDate=that.getFirstDayOfMonth(data,2);
            that.ruleForm.accountDate=that.GetPrevDay(that.ruleForm.accountDate);
            that.ruleForm.maxDate=that.GetPrevDay(that.ruleForm.maxDate);
            that.search();
        }
    };
</script>
