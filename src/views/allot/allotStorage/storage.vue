        ...
        <div class="pad_5 backfff">
            ...
            <div>
                <el-table :data="tableData" style="width: 100%" highlight-current-row @current-change="detailClick">
                    ...
                    <el-table-column prop="stockDestName" label="收货仓库"></el-table-column>
                    ...
                    <el-table-column prop="isState" label="单据状态" :formatter="formatStatus"></el-table-column>
    ...
    export default {
        ...
        methods: {
            ...
            handleDownload(){
                ...
                API.exportTI(params)
                    .then(res => {
                        ...
                        link.download = '调拨入库.xlsx'; //下载的文件名
            ...
            showEditDialog: function (row) {
                var that = this;
                that.$router.push({path: "/allot/allotStorage/storageDetail", query: {detail: row}})
            },
            // 确认收货
