        ...
        <div class="pad_5 backfff">
            ...
            <div class="nav_header">
                <el-form :model="ruleForm" :rules="rules" ref="ruleForm" :inline="true" class="demo-form-inline">
                    ...
                    <el-form-item label="发货仓库" prop="srcWarehouseID">
                        <el-select v-model="ruleForm.srcWarehouseID" filterable placeholder="请选择"
                                   @change="warehouseChange" size="mini">
                            <el-option
                                    v-for="item in warehouseAllList"
                    ...
                    <el-form-item label="收货仓库" prop="warehouseID">
                        <el-select v-model="ruleForm.warehouseID" filterable placeholder="请选择" @change="warehouseChange"
                                   size="mini">
                            <el-option
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            // 仓库列表
            warehouseAllData: function () {
                var that = this;
                API.getWarehouseAll()
                    .then(res => {
                        if (res.stateCode == 100) {
                            that.warehouseAllList = res.data;
                        } else {
                            that.$message.error({
                                message: res.message,
                                duration: 2000
                            ...
                            .then(res => {
                                if (res.stateCode == 100) {
                                    ...
                                    if (num == 1) {
                                        ...
                                        that.$router.push({path: "/allot/replenishmentApply/replenishment"})
                                    }
                                } else {
                                    that.$message.error({
                                        message: res.message,
