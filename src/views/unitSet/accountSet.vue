            ...
            <div>
                <el-form ref="ruleForm" :model="ruleForm" :rules="rules" label-width="100px" class="demo-ruleForm">
                    <el-form-item label="账套编号" prop="siteID">
                        <el-input v-model="ruleForm.siteID" placeholder="请输入1位大写字母加3位数字组合" :disabled="modalTitle=='编辑'"></el-input>
                    </el-form-item>
    ...
    export default {
        data() {
            return {
                ...
                rules: {
                    siteID: [{required: true, message: '请输入账套编号', trigger: 'blur'},{ pattern: /^[A-Z][0-9]{3}$/, message: '请输入1位大写字母加3位数字组合' }],
