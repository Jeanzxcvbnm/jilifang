                ...
                <el-table :data="tableData" style="width: 100%" highlight-current-row @current-change="detailClick">
                    ...
                    <el-table-column label="操作" width="180">
                        <template slot-scope="scope">
                            ...
                            <el-button type="primary" size="mini" v-if="scope.row.isConfirm ==5"
                                       @click="deliverClick(scope.row)">确认发货
                            </el-button>
                            <el-button type="primary" size="mini" v-if="scope.row.isConfirm ==6"
                                       @click="deliverClick(scope.row)">确认收货
                            </el-button>
                        </template>
                    </el-table-column>
                </el-table>
    ...
    export default {
        ...
        methods: {
            ...
            handleDownload(){
                ...
                API.exportSF(params)
                    .then(res => {
                        ...
                        link.download = '销售收发货.xlsx'; //下载的文件名
            ...
            showDetail: function (row) {
                var that = this;
                that.$router.push({path: "/salesBusiness/salesDelivery/salesDeliveryDetail", query: {detail: row}})
            },
            // 发货
            deliverClick: function (row) {
                var that = this;
                this.$confirm('此操作将确认收发货, 是否继续?', '提示', {
