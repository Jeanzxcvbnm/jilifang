        ...
        <div class="pad_15">
            <el-row>
                <el-col :span="24" class="text_right">
                    ...
                    <!--<el-button type="primary" size="mini" @click="">发送订单</el-button>-->
                    <el-button type="primary" size="mini" @click="saveClick(1)" :loading="modalLoading">保存并新增
                    </el-button>
            ...
            <div class="nav_header">
                <el-form :model="ruleForm" :rules="rules" ref="ruleForm" :inline="true" class="demo-form-inline">
                    <el-form-item label="供应商" prop="custID">
                        <el-select v-model="ruleForm.custID" placeholder="请选择" clearable size="mini">
                            <el-option
                    ...
                    <el-form-item label="客户商" prop="clientID">
                        <el-select v-model="ruleForm.clientID" filterable placeholder="请选择" size="mini">
                            <el-option
                    ...
                    <el-form-item label="发货仓库" prop="stockDest">
                        <el-select v-model="ruleForm.stockDest" filterable placeholder="请选择"
                                   @change="warehouseChange" size="mini">
                            <el-option
        ...
        data() {
            return {
                ...
                rules: {
                    ...
                    clientID: [{required: true, message: '请选择客户商', trigger: 'change'}],
                    stockDest: [{required: true, message: '请选择发货仓库', trigger: 'change'}],
                    ...
                    .then(res => {
                        if (res.stateCode == 100) {
                             res.data.forEach(function (item) {
                                  if(that.siteID == item.siteID){
                                      that.ruleForm.custID = item.custID
                                  }
                             })
            ...
            saveClick: function (num) {
                ...
                this.$refs.ruleForm.validate(valid => {
                    if (valid) {
                        ...
                        var params = {
                            custID: that.ruleForm.custID,
                            billDate: that.ruleForm.billDate,
                            stockDest: that.ruleForm.stockDest,
                            clientID: that.ruleForm.clientID,
                            entityID: that.ruleForm.entityID,
                            remark: that.ruleForm.remark,
                            saleOrderDEntities: that.replenishmentList
                        }
                        API.addSalesQuotation(params)
                            .then(res => {
                                if (res.stateCode == 100) {
                                    that.$message({
                                        message: res.message,
                                    ...
                                    if (num == 1) {
                                        ...
                                        that.$router.push({path: "/salesBusiness/salesQuotation/salesQuotation"})
                                    }
                                } else {
                                    that.$message.error({
                                        message: res.message,
