        ...
        <div class="pad_15">
            <el-row>
                <el-col :span="24" class="text_right">
                    ...
                    <!--<el-button type="primary" size="mini"  >单据作废</el-button>-->
                    <el-button type="primary" size="mini"  @click="saveClick">保存</el-button>
                    <!--<el-button type="primary" size="mini">发订单送</el-button>-->
                </el-col>
            </el-row>
        </div>
            ...
            <div class="nav_header">
                <el-form :model="ruleForm" :rules="rules" ref="ruleForm" :inline="true" class="demo-form-inline">
                    ...
                    <el-form-item label="发货仓库" prop="stockDestID">
                        <el-select v-model="ruleForm.stockDestID" filterable disabled placeholder="请选择"
...
<script>
    ...
    export default {
            ...
            saveClick: function () {
                ...
                this.$refs.ruleForm.validate(valid => {
                    if (valid) {
                        ...
                        API.updateSalesQuotation(params)
                            .then(res => {
                                if (res.stateCode == 100) {
                                    that.$message({
                                        message: res.message,
        ...
        mounted() {
            ...
            that.ruleForm.custID = detail.custID || "";
            that.ruleForm.entityID=detail.entityID;
            that.ruleForm.custName=detail.custName;
            that.ruleForm.stockDestID=detail.warehouseID;
            that.ruleForm.clientID=detail.clientID;
