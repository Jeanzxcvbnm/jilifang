                ...
                <el-row>
                    <el-col :span="24">
                        <el-form :inline="true" class="demo-form-inline">
                            ...
                            <el-form-item style="margin-left: 30px;">
                                <el-button type="primary" size="mini" @click="handleDownload" :loading="downloadLoading">导出</el-button>
                            </el-form-item>
                        </el-form>
                    </el-col>
                </el-row>
    ...
    export default {
        ...
        methods: {
            ...
            showAddDialog: function () {
                var that = this;
                that.$router.push("/stockControl/purchase/addPurchase")
            },
            // 数据显示
            ...
            showEditDialog: function (row) {
                var that = this;
                that.$router.push({path:"/stockControl/purchase/details",query:{detail:row}})
            },
            // 明细
