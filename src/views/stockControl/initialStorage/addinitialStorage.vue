        ...
        <div class="pad_15">
            <el-row>
                <el-col :span="24" class="text_right">
                    ...
                    <el-button type="primary" size="mini" @click="saveClick" :loading="modalLoading">保存</el-button>
                </el-col>
            </el-row>
        </div>
        ...
        <div class="pad_10 backfff martp_15">
            <div class="pad_10 nav_header">
                ...
                <el-upload
                        ...
                        :http-request="excleFile"
                        accept=".xls,.xlsx,application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, application/vnd.ms-excel"
                        action="/"
                >
                    <el-button type="primary" size="mini" icon="el-icon-s-fold">导入</el-button>
                </el-upload>
                <el-button type="primary" size="mini" icon="el-icon-s-unfold" class="marlt_15" @click="downloadClick">
                    下载模板
                </el-button>
                ...
                <el-table :data="replenishmentList" ref="multipleTable" tooltip-effect="dark"
                    ...
                    <el-table-column prop="name" label="名称" width="200">
                        <template slot-scope="scope">
                            <div v-if="scope.row.isTake">{{scope.row.name}}</div>
                            <el-select v-else class="width__fill_available" v-model="scope.row.isAdd"
                                       v-loadmore="loadMore"
    ...
    export default {
        ...
        methods: {
            ...
            excleFile(options) {
                ...
                API.excleUpload(formData)
                    .then(function (res) {
                        if (res.stateCode == 100) {
                            res.data.data.forEach(function (item) {
                                item.isTake = true;
                                item.unitAmount = item.amount;
                                item.amount = item.amount * item.inAmount;
            ...
            downloadClick: function () {
                window.location.href = "https://zl-sys.oss-cn-qingdao.aliyuncs.com/excel2.0.xls"
            },
            // 仓库列表
            ...
            UnitChange: function (index, row, value) {
                ...
                that.replenishmentList[index].maxPrice=(row.unitAmount * row.price).toFixed(2);
