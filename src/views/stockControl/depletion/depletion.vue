<template>
    <div v-loading="loading">
        <div class="pad_5 backfff">
                ...
                <el-row>
                    <el-col :span="24">
                        <el-form :inline="true" class="demo-form-inline">
                            ...
                            <el-form-item label="消耗部门" v-if="false">
                                <el-select v-model="entityID" placeholder="请选择" clearable size="mini">
                                    <el-option
            ...
            <div>
                <el-table :data="tableData" style="width: 100%" highlight-current-row @current-change="detailClick">
                    ...
                    <el-table-column prop="warehouseName" label="消耗仓库"></el-table-column>
        ...
        <div class="pad_10 backfff martp_15">
            ...
            <div>
                <el-table :data="orderDetail" show-summary :summary-method="getSummaries" max-height="400" style="width: 100%">
                    <el-table-column type="index" label="序号"></el-table-column>
    ...
    export default {
        ...
        methods: {
            handleDownload(){
                ...
                API.exportUO(params)
                    .then(res => {
                        ...
                        link.download = '消耗出库.xlsx'; //下载的文件名
            ...
            showAddDialog: function () {
                var that = this;
                that.$router.push("/stockControl/depletion/addDepletion")
            },
            // 数据显示
            ...
            showEditDialog: function (row) {
                var that = this;
                that.$router.push({path:"/stockControl/depletion/details",query:{detail:row}})
            },
            // 明细
